...
import com.example.chatbro.adapters.ChatAdapter;
...
import com.example.chatbro.network.ApiClient;
import com.example.chatbro.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void init(){
        ...
        chatAdapter = new ChatAdapter(
                ...
                preferenceManager.getString(Constants.KRY_USER_ID)
        );
    ...
    private void sendMessage(){
        ...
        message.put(Constants.KEY_SENDER_ID, preferenceManager.getString(Constants.KRY_USER_ID));
        ...
        if (conversionId != null){
            ...
            conversion.put(Constants.KEY_SENDER_ID, preferenceManager.getString(Constants.KRY_USER_ID));
        ...
        if (!isReceiverAvailable){
            try {
                ...
                data.put(Constants.KRY_USER_ID, preferenceManager.getString(Constants.KRY_USER_ID));
    ...
    private void checkForConversionRemotely(String serderId,String receiverId){
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                .whereEqualTo(Constants.KEY_SENDER_ID,serderId)
